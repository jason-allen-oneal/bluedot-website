...
const services = [
  {
    ...
    subtitle: "Web, API, and infrastructure testing that produces actionable fixes.",
    bullets: [
    ...
    deliverables: ["Executive summary", "Technical report", "Risk-ranked findings", "Retest option"],
  },
  {
  ...
  },
  {
    ...
    deliverables: ["Hardening checklist", "Config diffs", "Pipeline updates", "Verification notes"],
  },
  {
    title: "Secure Software Development",
    subtitle: "Security-first feature delivery for teams that need velocity without regret.",
    bullets: [
    ...
    deliverables: ["PRs and releases", "Architecture notes", "Tests", "Maintenance plan"],
  },
];
...
function Button({ children, href, variant = "primary" }: { children: any, href: string, variant?: string}) {
  const base =
          ...
          <div>
            ...
            <dl className="mt-8 grid gap-4 sm:grid-cols-3">
              <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                <dt className="text-sm font-semibold text-slate-900">Engagements</dt>
                <dd className="mt-1 text-sm text-slate-700">Fixed scope or sprint-based</dd>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                <dt className="text-sm font-semibold text-slate-900">Deliverables</dt>
                <dd className="mt-1 text-sm text-slate-700">Report, code, or both</dd>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                <dt className="text-sm font-semibold text-slate-900">Turnaround</dt>
                <dd className="mt-1 text-sm text-slate-700">Fast, with documented results</dd>
              </div>
            </dl>
          </div>
        ...
        <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl bg-slate-50 p-5">
              <p className="text-sm font-semibold text-slate-900">Discovery Sprint</p>
              <p className="mt-1 text-sm text-slate-700">
                Short, focused sprint to define scope, confirm assumptions, and map risk.
              </p>
            </div>
            <div className="rounded-2xl bg-slate-50 p-5">
              <p className="text-sm font-semibold text-slate-900">Fixed-Scope Project</p>
              <p className="mt-1 text-sm text-slate-700">
                Clear targets and deliverables. Best for pentests and hardening packages.
              </p>
            </div>
            <div className="rounded-2xl bg-slate-50 p-5">
              <p className="text-sm font-semibold text-slate-900">Retainer</p>
              <p className="mt-1 text-sm text-slate-700">
                Ongoing support for security fixes, tooling, and secure delivery improvements.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 flex flex-wrap items-center justify-between gap-4">
            <p className="text-sm text-slate-700">
              If you want a number, you need a scope. Book a call and I will give you a real quote.
            </p>
