...
export default async function Terms() {
    return (
        ...
        <header className="mb-8">
          <h1 className="text-3xl font-bold mb-4 text-cyan-200">Terms of Service</h1>
        ...
        <div className="space-y-8">
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-cyan-300">Agreement to Terms</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-cyan-300">Description of Service</h2>
            <p className="mb-4 text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-cyan-300">User Accounts</h2>
            <p className="mb-4 text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-cyan-300">Acceptable Use</h2>
            <p className="mb-4 text-slate-300 leading-relaxed">You agree not to use the Service to:</p>
            <ul className="list-disc pl-6 mb-6 space-y-2 text-slate-300">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-cyan-300">Content and Comments</h2>
            <p className="mb-4 text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-cyan-300">Intellectual Property</h2>
            <p className="mb-4 text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-cyan-300">Privacy</h2>
            <p className="mb-4 text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-cyan-300">Links to Other Websites</h2>
            <p className="mb-4 text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-cyan-300">Termination</h2>
            <p className="mb-4 text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-cyan-300">Limitation of Liability</h2>
            <p className="mb-4 text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-cyan-300">Governing Law</h2>
            <p className="mb-4 text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-cyan-300">Changes to Terms</h2>
            <p className="mb-4 text-slate-300 leading-relaxed">
